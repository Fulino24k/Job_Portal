<html>
    ...
    <body>
        ...
        function acceptDenyButtons() {
            echo "Actions: <br><br>";
            echo "<div><button onclick='updateAccept()'>Accept Offer</button><button onclick='updateDeny()'>Deny Offer</button></div>";
        ...
        function handlePrintOffer() {
            ...
            // echo "Actions: <br><br>";
            // echo "<div><button onclick='acceptOffer()'>Accept Offer</button><button onclick='denyOffer()'>Deny Offer</button></div>";
        }
        ...
        <form method="POST" action="project.php">  
            ...
            <input type="submit" value="UpdateDeny" name="updateSubmitDeny"></p>
        </form>
        <hr/>
        </div>
        ...
        <form id="updateAccount" style="display: none" method="POST" action="project.php"> 
          ...
          <!-- form for updating offer deny -->
          <!--
          <form id="denyOffer" style="display: none" method="POST" action="project.php"> 
            <input type="hidden" id="denyOfferRequest" name="denyOfferRequest">
            Employee Number: <input type="text" name="empNum"> <br /><br />
            <input type="submit" value="denyOffer" name="updateSubmitDeny"></p>
        </form>
        -->
        ...
        <form id="updatePhone" style="display: none" method="POST" action="project.php"> <!--refresh page when submitted-->
         ...
         <!-- form for updating deny -->
         <!-- <form id="updateDeny" style="display: none" method="POST" action="project.php"> 
            <input type="hidden" id="updateDenyQueryRequest" name="updateDenyQueryRequest">
            Employee number: <input type="text" name="empNum"> <br /><br />
            <input type="submit" value="UpdateDeny" name="updateSubmitDeny"></p>
        </form> -->
...
.
        ...
        <!-- <form id="manageOfferForm" method="GET" action="project.php"> 
            <input type="hidden" id="manageButtonRequest" name="manageButtonRequest">
            <input type="hidden" name="manageOffer"></p>
        </form> -->
        ...
        // //deny offer:
        // function handleOfferUpdateRequest() {
        //     global $db_conn;
        //     $emp_num = $_POST['empNum'];
        //     // you need the wrap the old name and new name values with single quotations
        //     executePlainSQL("DELETE FROM offerTable WHERE offer_employee_num='" . $emp_num . "'");
        //     OCICommit($db_conn);
        // }  
        ...
        if (isset($_POST['resetAll']) || isset($_POST['insertSubmitInterview']) || isset($_POST['insertSubmitAccount']) || isset($_POST['insertSubmitOffer']) || 
            isset($_POST['updateSubmitAddy']) || isset($_POST['updateSubmitPhone']) || isset($_POST['updateSubmitDeny'])) {
            handlePOSTRequest();
        }
        ...
        function handleGETRequest() {
            if (connectToDB()) {
                if (array_key_exists('printJob', $_GET)) {
                    ...
                    printManageButtons();
                // } else if (array_key_exists('manageOffer', $_GET)) {
